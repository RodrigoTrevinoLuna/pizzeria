                ...
                <div class="col-lg-5 p-5">
                        <div class="col p-4 bg-light rounded">
                            <div class="row">
                                ...
                                <div class="col-lg-6"><h1 class="text-center">Editar Proveedor</h1></div>
                                <div class="col-lg-3"><img src="../../imagenes/pizza.png" style="width: 70px;"></div>
                            </div>
                        <hr class="bg-dark">
                                <form action="editarPBD.php" method="POST">
                                    <?php  while ($fila = mysqli_fetch_array($resultado)){ ?>
                                    <div class="list-group">
                                        <input type="hidden" name = "id" value="<?php  echo $fila["idProveedor"];?>">
                                            <label>Proveedor:<input class="col" type="text" name="proveedor" value="<?php echo $fila["proveedor"];?>"></label>
                                            <label>Telefono:<input class="col" type="text" name="telefono"value="<?php echo $fila["telefono"];?>"></label>
                                            <label>Correo:<input class="col" type="text" name="correo" value="<?php echo $fila["correo"];?>"></label>
                                            <label>Dirección:<textarea class="col" name="direccion" ><?php echo $fila["direccion"];?></textarea></label>
